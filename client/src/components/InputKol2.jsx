      ...
      <div className="space-y-4 md:space-y-6">
        ...
        <div className="bg-emerald-50 border border-emerald-200 rounded-lg md:rounded-xl p-3 md:p-4 mb-4">
          <div className="flex items-start">
            ...
            <div>
              <p className="text-xs md:text-sm font-medium text-emerald-800">Cara Input Kol. 2:</p>
        ...
        <div className="p-4 md:p-6 border-b border-gray-200">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
            <div className="flex items-center mb-3 md:mb-0">
              ...
              <h2 className="text-lg md:text-xl font-semibold text-gray-900">Pilih Periode Kol. 2</h2>
            </div>
